...
const submit = async () => {
    ...
    let base64Response = await fetch(form2.value.image_emp_file1);
    form_data.image_emp_file1 = await base64Response.blob();

    base64Response = await fetch(form3.value.image_emp_file2);
    form_data.image_emp_file2 = await base64Response.blob();

    base64Response = await fetch(form4.value.image_emp_file3);
    form_data.image_emp_file3 = await base64Response.blob();

    base64Response = await fetch(form5.value.image_emp_file4);
    form_data.image_emp_file4 = await base64Response.blob();

    base64Response = await fetch(form6.value.image_id_file1);
    form_data.image_id_file1 = await base64Response.blob();

    base64Response = await fetch(form7.value.image_id_file2);
    form_data.image_id_file2 = await base64Response.blob();

    base64Response = await fetch(form8.value.image_id_file3);
    form_data.image_id_file3 = await base64Response.blob();
                    ...
                    <div class="flex-1 z-0 w-[100%] overflow-auto">
                        ...
                        <div class="flex flex-col md:flex-row gap-1 w-[100%] ">
                            <div class=" w-[100%] md:w-3/4 overflow-hidden border border-green-900 flex flex-col gap-3">
                                <img class="object-cover object-center" :src="form.image_emp_link1" />
                                <img class="object-cover object-center" :src="form.image_emp_link2" />
                                <img class="object-cover object-center" :src="form.image_emp_link3" />
                                <img class="object-cover object-center" :src="form.image_emp_link4" />
                                <div class="flex flex-col lg:flex-row">
                                    <div class="w-[100%] md:w-[65%]">
                                        <img class="w-full object-cover object-center" :src="form.image_id_link1" />
                                    </div>
                                ...
                                <div class="flex flex-col gap-2 lg:flex-row">
                                    <div class="w-[100%] md:w-[65%]">
                                        <img class="w-full object-cover object-center" :src="form.image_id_link2" />
                                    </div>
                                ...
                                <div class="flex flex-col gap-2 lg:flex-row">
                                    <div class="w-[100%] md:w-[65%]">
                                        <img class="w-full object-cover object-center" :src="form.image_id_link3" />
                                    </div>
                                    <div class="w-[100%] p-2 md:flex-1 flex flex-col">
                                        <div>
                                            <Label class="mb-2">ID No</Label>
