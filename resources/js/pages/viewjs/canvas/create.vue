...
const breadcrumbs: bc[] = [
    {
        title: 'Take Photo',
        href: photo.index().url,
    },
];
const headTitle = 'Take Photo';
...
//<WebCamUI :fullscreenState="false" @photoTaken="photoTaken" class="w-[100%] lg:w-[80%] text-black" />


// registration of global cross page variables starts
...
// registration of global cross page variables ended
            ...
            <div class="absolute top-0 h-[100%] w-full bg-neutral-150 ">
                <div class="flex flex-col w-full h-[100%]  text-white px-4 py-3 gap-2">
                    ...
                    <div class="flex-1 z-0 w-[100%] overflow-auto">
                        ...
                        <span>Check the Console Log for its output after the Take a Photo button is clicked</span>
                        <WebCamUI :fullscreenState="false" @photoTaken="photoTaken"
                            class="w-[100%] lg:w-[80%] text-black" />
